...
class Serializer implements SerializerInterface
{
    ...
    public function deserialize(mixed $data, string $type, string $format = 'json', array $context = [])
    {
        return $this->serializer->deserialize($data, $type, $format, $context);
    }

    public function serialize(mixed $data, string $format = 'json', array $context = [])
    {
